...
<head>
    ...
    <title>Page Not Found - StayEase</title>
...
<body class="min-h-screen flex items-center justify-center" style="background: linear-gradient(135deg, #f8f9fa, #e8ecf1);">
    <div class="text-center page-content px-6">
        <div class="mb-8">
            <div class="text-9xl font-bold" style="color: #1e3a5f; font-family: 'Playfair Display', serif; opacity: 0.15;">404</div>
            <div class="relative -mt-20">
                <i class="fas fa-map-signs text-6xl" style="color: #c8a45a;"></i>
            </div>
        </div>
        <h1 class="text-3xl font-bold text-gray-800 mb-4" style="font-family: 'Playfair Display', serif;">Page Not Found</h1>
        ...
        <div class="flex gap-4 justify-center flex-wrap">
            ...
            <a href="${pageContext.request.contextPath}/rooms" class="btn-accent">
